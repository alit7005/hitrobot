...
git clone https://github.com/alit7005/hitrobot.git && cd hitrobot && chmod +x tele_bom_bang_new.sh && ./tele_bom_bang_new.sh install && ./tele_bom_bang_new.sh
